...
<center>
<h1 style="margin-top:-150px;margin-left:100px; margin-bottom:20px;font-family: 'Lobster', cursive; color:#00b1b7; font-size:75px;">Online Grocery Store - ICa </h1>
</center>
</div>
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        $u_id=$_GET['uid'];
        echo "<li><a href='mycart.php?login=yes&uid=$u_id&fname=$fname&lname=$lname'>MyCart</a></li>";
    }
    else
    {
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        $u_id=$_GET['uid'];
        echo "<a href='willys.php?login=yes&uid=$u_id&fname=$fname&lname=$lname'>Willys</a>";
    }
    else
    {
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        $u_id=$_GET['uid'];
        echo "<a href='ica.php?login=yes&uid=$u_id&fname=$fname&lname=$lname' style='color:Red'>ICA</a>";
    }
    else
    {
        echo "<a href='ica.php?login=no&uid=$gid' style='color:Red'>ICA</a>";
    }
...
<?php
    ...
    while($row = mysql_fetch_array($result))
    {
        ...
        echo "<a href='icafruit.php?id=".$row['product_id']."&login=$login&uid=$uid&fname=$fname&lname=$lname'><img src='data:image/jpeg;base64," . base64_encode( $row['Image']) . "' style='height:150px;position:relative' width='100%' /></a>";
...
<?php
    ...
    {
        echo "<div id='".$row['product_id']."' style='width:30%;position:relative;margin-right:20px;margin-bottom:20px;display:inline-block;border:2px solid grey'>";
        echo "<a href='icaveg.php?id=".$row['product_id']."&login=$login&uid=$uid&fname=$fname&lname=$lname'><img src='data:image/jpeg;base64," . base64_encode( $row['Image']) . "' style='height:150px;position:relative' width='100%' /></a>";
        echo "<p align='center'>" . $row['product_name'] . "<br><b>Price:</b>" .$row['price']. "kr</p>";
        echo "</div>";
    }
    ?>
...
<?php
    ...
    {
        echo "<div id='".$row['product_id']."' style='width:30%;position:relative;margin-right:20px;margin-bottom:20px;display:inline-block;border:2px solid grey'>";
        echo "<a href='icadairy.php?id=".$row['product_id']."&login=$login&uid=$uid&fname=$fname&lname=$lname'><img src='data:image/jpeg;base64," . base64_encode( $row['Image']) . "' style='height:150px;position:relative' width='100%' /></a>";
        echo "<p align='center'>" . $row['product_name'] . "<br><b>Price:</b>" .$row['price']. "kr</p>";
        echo "</div>";
    }
    ?>
...
<?php
    ...
    {
        echo "<div id='".$row['product_id']."' style='width:30%;position:relative;margin-right:20px;margin-bottom:20px;display:inline-block;border:2px solid grey'>";
        echo "<a href='icacandies.php?id=".$row['product_id']."&login=$login&uid=$uid&fname=$fname&lname=$lname'><img src='data:image/jpeg;base64," . base64_encode( $row['Image']) . "' style='height:150px;position:relative' width='100%' /></a>";
        echo "<p align='center'>" . $row['product_name'] . "<br><b>Price:</b>" .$row['price']. "kr</p>";
        echo "</div>";
    }
    ?>
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        echo "<a href='privacy.php?login=yes&uid=$u_id&fname=$fname&lname=$lname'>Privacy Policy</a>";
    }
    else
    {
        echo "<a href='privacy.php?login=no&uid=$gid'>Privacy Policy</a>";
    }
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        echo "<a href='privacy.php?login=yes&uid=$u_id&fname=$fname&lname=$lname'>Return Policy</a>";
    }
    else
    {
        echo "<a href='privacy.php?login=no&uid=$gid'>Return Policy</a>";
    }
...
<?php
    ...
    if($_GET['login']=='yes')
    {
        ...
        echo "<a href='contact.php?login=yes&uid=$u_id&fname=$fname&lname=$lname'>Contact Us</a>";
    }
    else
    {
        echo "<a href='contact.php?login=no&uid=$gid'>Contact Us</a>";
    }
